      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-4 py-2 bg-white border-2 border-border/60 rounded-xl">
              ...
              <span className="text-sm">{autoRefresh ? 'Tự động làm mới BẬT' : 'Tự động làm mới TẮT'}</span>
              <button
        ...
        <div className="bg-white/80 backdrop-blur-sm border-2 border-border/60 rounded-2xl p-4">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <option value="all">-- Loại nội dung --</option>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-1">Phân tích</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-1">Công cụ AI</h3>
