...
import { Search, Plus, Edit2, Trash2, Shield, Mail, Phone, Calendar, Lock, CheckCircle, XCircle, Filter, Download, MoreVertical, User as UserIcon, Crown, Star } from 'lucide-react';
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-foreground mb-2">Quản lý người dùng</h1>
